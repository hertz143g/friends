...
const PRODUCTS = {
  "Смартфоны": [
    { id: 1, name: "iPhone 15 Pro 128GB Серый", brand: "iPhone", price: 115000, img: PHONE_PLACEHOLDER, description: "Флагман 2024" },
    { id: 2, name: "Galaxy S24 Ultra 256GB", brand: "Samsung S24/S25", price: 98000, img: PHONE_PLACEHOLDER, description: "Лучший Android" },
    { id: 3, name: "Xiaomi Redmi Note 13 Pro", brand: "Xiaomi", price: 34000, img: PHONE_PLACEHOLDER, description: "Топ за свои" },
  ],
  "Часы": [
    { id: 4, name: "Apple Watch Series 9", brand: "Apple Watch", price: 37000, img: PHONE_PLACEHOLDER, description: "Новые цвета" },
    { id: 5, name: "Casio G-SHOCK", brand: "Casio G-SHOCK", price: 8900, img: PHONE_PLACEHOLDER, description: "Ультра-надёжные" },
    { id: 6, name: "Garmin Forerunner", brand: "Garmin", price: 28500, img: PHONE_PLACEHOLDER, description: "Для спорта" }
  ],
  "Компьютеры и планшеты": [
    { id: 7, name: "MacBook Air 15 2024", brand: "MacBook", price: 127000, img: PHONE_PLACEHOLDER, description: "Тонкий и лёгкий" },
    { id: 8, name: "iMac 24\" 2024", brand: "iMac", price: 159000, img: PHONE_PLACEHOLDER, description: "Яркий экран" },
    { id: 9, name: "iPad Pro 11\" 2024", brand: "iPad", price: 99000, img: PHONE_PLACEHOLDER, description: "На M4 чипе" }
  ],
  "Аудио": [
    { id: 10, name: "AirPods Pro 2", brand: "AirPods", price: 25900, img: PHONE_PLACEHOLDER, description: "Лучшие наушники Apple" },
    { id: 11, name: "Marshall Emberton II", brand: "Marshall", price: 18500, img: PHONE_PLACEHOLDER, description: "Брутальный звук" },
    { id: 12, name: "Sony WH-1000XM5", brand: "Аксессуары", price: 29900, img: PHONE_PLACEHOLDER, description: "Топ шумодав" }
  ],
  "Телевизоры": [
    { id: 13, name: "Xiaomi TV A32", brand: "Телевизоры", price: 16000, img: TV_PLACEHOLDER, description: "Лёгкий SmartTV" },
    { id: 14, name: "Samsung 4K Crystal", brand: "Телевизоры", price: 37000, img: TV_PLACEHOLDER, description: "4K для дома" }
  ],
  "Игровые приставки": [
    { id: 15, name: "PlayStation 5", brand: "Sony Ps5", price: 68900, img: PHONE_PLACEHOLDER, description: "Next Gen" },
    { id: 16, name: "Xbox Series X", brand: "Xbox", price: 64800, img: PHONE_PLACEHOLDER, description: "Лучший Game Pass" }
  ],
  "Игрушки": [
    { id: 17, name: "Labubu Pirate", brand: "Игрушки Labubu", price: 3300, img: PHONE_PLACEHOLDER, description: "Коллекционная игрушка" }
  ],
  "Электроника": [
    { id: 18, name: "Apple TV 4K", brand: "Apple TV", price: 25900, img: PHONE_PLACEHOLDER, description: "Кино и сериалы" },
    { id: 19, name: "GoPro Hero", brand: "GoPro", price: 38500, img: PHONE_PLACEHOLDER, description: "Экшен-камера" }
  ]
};
  ...
  return (
    ...
    >
      ...
      {qty === 0 ? (
        <motion.button
          onClick={handlePlus}
          animate={addAnim ? { scale: [1, 1.12, 0.97, 1] } : { scale: 1 }}
