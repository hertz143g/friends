    ...
    <Particles
      ...
      options={{
        ...
        particles: {
          color: { value: "#3ca4ff" },
          links: {
            color: "#3ca4ff99", distance: 140,
            enable: true, opacity: 0.18, width: 1
          },
          move: { enable: true, speed: 1.1, outModes: { default: "bounce" } },
          number: { density: { enable: true, area: 900 }, value: 36 },
          opacity: { value: 0.33 },
          shape: { type: "circle" },
          size: { value: { min: 1.3, max: 4.2 } }
        },
        detectRetina: true
      }}
    />
  ...
  return (
    <>
      ...
      >
        ...
        {/* ---- Ниже твой код: категории, товары, корзина (ничего не менялось) ---- */}
        <AnimatePresence>
          {!activeCategory && !showCart && (
            <motion.div
              key="main"
